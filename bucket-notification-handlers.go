...
func (api objectAPIHandlers) PutBucketNotificationHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err = validateNotificationConfig(notificationCfg); err != nil {
		errorIf(err, "Invalid notification configuration.")
		writeErrorResponse(w, r, toAPIErrorCode(err), r.URL.Path)
		return
	}
	if err = enableNotification(notificationCfg); err != nil {
		errorIf(err, "Unable to inititalize notification.")
		writeErrorResponse(w, r, toAPIErrorCode(err), r.URL.Path)
		return
	}
